...
function stay() {
    ...
    let message = "";
    let messageColor = "#000000"; // Default color is black

    if (yourSum > 21) {
        message = "You Lose!";
        messageColor = "#76ABAE"; // Change color to #76ABAE
    }
    ...
    document.getElementById("results").style.color = messageColor; // Change message color
